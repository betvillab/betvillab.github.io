...
* **PhD in Computer Vision**, University of Twente, Enschede, Netherlands (Sep 2023 – Present)
  * Research focus: Computer vision for real-time defect detection in industrial assembly processes
  * Supervisor: Dr. Estefanía Talavera
* **MSc in Mechatronics and Micromechatronic Systems**, Universidad de Oviedo / Karlsruhe University of Applied Sciences, Spain/Germany (Sep 2018 – Sep 2020)
  * Erasmus Mundus Joint Master Scholarship
  * Thesis: *Control and Monitoring of an induction hardening test bench*
* **BSc in Mechatronics Engineering**, Universidad Autónoma del Caribe, Colombia (Jan 2010 – Mar 2015)
  * Thesis: *Digital image processing applied on static sign language recognition system*

Research Experience
======
* **PhD Researcher – Computer Vision for Industrial Inspection**, University of Twente (Sep 2023 – Present)
  * Developing deep learning and computer vision algorithms for automated defect detection in industrial assembly processes
  * Designing machine learning pipelines for visual inspection systems
  * Integrating real-time monitoring solutions into industrial production environments
  * Investigating robustness and scalability of inspection models in manufacturing settings
...
======
* **Women in AI and Robotics** — Volunteer, promoting women's participation in AI and robotics
* **Organization of Women in Science for the Developing World (OWSD)** — Volunteer, supporting women scientists in developing countries
